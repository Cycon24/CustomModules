...
def shockDeflection(Mach=None,Beta_deg=None,Theta_deg=None, Gamma = 1.4):
    ...
    Theta_deg : TYPE, optional
        Wedge angle [deg]. The default is None.
...
def As_At_n(Ae_At, Pb_Po, Gamma=1.4, dx=1e-3, max_iter=30):
    ...
    try: 
        ...
        print('FAILED: PR_b = {:6.5f} r1 = '.format(Pb_Po1_target),low_r, '  r2 = ',high_r)
...
if __name__ == "__main__":
    print('')
    Ae = 0.000356764988603265
    At = 0.00024980112185631444
    Ae_At = Ae/At 
    Po = 99.361353041952
    Pb = 64.3614
    Pb_Po = Pb/Po
    
    print(As_At_n(Ae_At,Pb_Po))
